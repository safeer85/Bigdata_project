...
FUEL_PRICE_PER_LITRE = env_float("FUEL_PRICE_PER_LITRE", 45.0)
MAINT_DAILY_STANDING = env_float("MAINT_DAILY_STANDING", 90.0)
SERVICE_COST_MIN = env_float("SERVICE_COST_MIN", 400.0)
SERVICE_COST_MAX = env_float("SERVICE_COST_MAX", 1400.0)
